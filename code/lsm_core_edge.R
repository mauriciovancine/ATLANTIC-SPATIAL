...
lsm_core_edge <- function(input,
    ...
    if(core_edge_type == "both" | core_edge_type == "core"){
        ...
        if(calculate_area == TRUE){
            ...
            lsm_fragment_area(input = paste0(input, output, "_core", edge_depth), id = id | core_number, ncell = ncell, area_integer = area_integer)
    ...
    if(core_edge_type == "both" | core_edge_type == "edge"){
        ...
        if(calculate_area == TRUE){
            ...
            lsm_fragment_area(input = paste0(input, output, "_edge", edge_depth))
