#' ----
#' title: atlantic spatial - import and prepare data - anthropogenic roads and railways
...
roads_argentina_national <- sf::st_read("01_data/05_roads_railways/00_raw/roads_argentina_national.shp") %>%
  dplyr::filter(rst == "1") %>%
  sf::st_make_valid() %>%
...
roads_argentina_provincial <- sf::st_read("01_data/05_roads_railways/00_raw/roads_argentina_provincial.shp") %>%
  dplyr::filter(rst == "1") %>%
  sf::st_make_valid() %>%
  sf::st_transform(sf::st_crs(af_lim)) %>%
  terra::vect()
...
roads_paraguay <- sf::st_read("01_data/05_roads_railways/00_raw/roads_paraguay.shp") %>%
  sf::st_make_valid() %>%
  sf::st_transform(sf::st_crs(af_lim)) %>%
  terra::vect()
...
railways_argentina <- sf::st_read(dsn = "01_data/05_roads_railways/00_raw/railways_argentina.shp") %>%
  sf::st_make_valid() %>%
  sf::st_transform(sf::st_crs(af_lim)) %>%
  terra::vect()
...
rgrass::execGRASS(cmd = "r.mapcalc",
                  flags = "overwrite",
                  expression = "491_atlantic_spatial_roads_binary = if(isnull(roads_af_lim_null), 0, 1)")
...
rgrass::execGRASS(cmd = "r.mapcalc",
                  flags = "overwrite",
                  expression = "493_atlantic_spatial_railways_binary = if(isnull(railways_af_lim_null), 0, 1)")
...
rgrass::execGRASS(cmd = "r.mapcalc",
                  flags = "overwrite",
                  expression = "495_atlantic_spatial_roads_railways_binary = if(isnull(roads_railways_af_lim_null), 0, 1)")

# export ------------------------------------------------------------------

# export
rgrass::execGRASS(cmd = "v.out.ogr", input = "roads_argentina_af_lim", output = "01_data/05_roads_railways/roads_argentina_af_lim.gpkg")
rgrass::execGRASS(cmd = "v.out.ogr", input = "roads_brazil_af_lim", output = "01_data/05_roads_railways/roads_brazil_af_lim.gpkg")
rgrass::execGRASS(cmd = "v.out.ogr", input = "roads_paraguay_af_lim", output = "01_data/05_roads_railways/roads_paraguay_af_lim.gpkg")
rgrass::execGRASS(cmd = "v.out.ogr", input = "roads_af_lim", output = "01_data/05_roads_railways/roads_af_lim.gpkg")

rgrass::execGRASS(cmd = "v.out.ogr", input = "railways_argentina_af_lim", output = "01_data/05_roads_railways/railways_argentina_af_lim.gpkg")
rgrass::execGRASS(cmd = "v.out.ogr", input = "railways_brazil_af_lim", output = "01_data/05_roads_railways/railways_brazil_af_lim.gpkg")
rgrass::execGRASS(cmd = "v.out.ogr", input = "railways_af_lim", output = "01_data/05_roads_railways/railways_af_lim.gpkg")

rgrass::execGRASS(cmd = "r.out.gdal", input = "491_atlantic_spatial_roads_binary", output = "01_data/05_roads_railways/491_atlantic_spatial_roads_binary.tif", createopt = "COMPRESS=DEFLATE,TFW=YES")
rgrass::execGRASS(cmd = "r.out.gdal", input = "493_atlantic_spatial_railways_binary", output = "01_data/05_roads_railways/493_atlantic_spatial_railways_binary.tif", createopt = "COMPRESS=DEFLATE,TFW=YES")
rgrass::execGRASS(cmd = "r.out.gdal", input = "495_atlantic_spatial_roads_railways_binary", output = "01_data/05_roads_railways/495_atlantic_spatial_roads_railways_binary.tif", createopt = "COMPRESS=DEFLATE,TFW=YES")
